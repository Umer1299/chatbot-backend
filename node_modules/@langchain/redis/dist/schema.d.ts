import { RediSearchSchema, SchemaFieldTypes, VectorAlgorithms, createClient } from "redis";
 ...
 */
declare const DEFAULT_TAG_SEPARATOR = ",";
/**
 ...
 * ```
 */
declare function buildMetadataSchema(metadataSchema: MetadataFieldSchema[], defaultSchema: RediSearchSchema): RediSearchSchema;
/**
 ...
 * ```
 */
declare function serializeMetadataField(fieldSchema: MetadataFieldSchema, fieldValue: unknown): string | number;
/**
 ...
 * ```
 */
declare function deserializeMetadataField(fieldSchema: MetadataFieldSchema, fieldValue: unknown): unknown;
/**
 ...
 * ```
 */
declare function inferMetadataSchema(documents: Document[]): MetadataFieldSchema[];
/**
 ...
 * ```
 */
declare function checkForSchemaMismatch(customSchema: MetadataFieldSchema[], inferredSchema: MetadataFieldSchema[]): boolean;
/**
