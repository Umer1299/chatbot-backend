 ...
 * @see https://redis.io/docs/latest/develop/ai/search-and-query/query/
 */
declare abstract class FilterExpression {
  /**
 ...
 * ```
 */
declare class AndFilter extends FilterExpression {
  readonly filters: [FilterExpression, FilterExpression];
  readonly filterType: "and";
  constructor(filters: [FilterExpression, FilterExpression]);
  toString(): string;
}
/**
 ...
 * ```
 */
declare class OrFilter extends FilterExpression {
  readonly filters: [FilterExpression, FilterExpression];
  readonly filterType: "or";
  constructor(filters: [FilterExpression, FilterExpression]);
  toString(): string;
}
/**
 ...
 * ```
 */
declare class TagFilter extends FilterExpression {
  private field;
  private values;
  private negate;
  readonly filterType: "tag";
  constructor(field: string, values: string | string[] | Set<string>, negate?: boolean);
  /**
  ...
  static create(field: string): {
    eq: (values: string | string[] | Set<string>) => TagFilter;
    ne: (values: string | string[] | Set<string>) => TagFilter;
  };
  toString(): string;
}
/**
 ...
 * ```
 */
declare class NumericFilter extends FilterExpression {
  private field;
  private operator;
  private value;
  private negate;
  readonly filterType: "numeric";
  constructor(field: string, operator: "eq" | "ne" | "gt" | "gte" | "lt" | "lte" | "between", value: number | [number, number], negate?: boolean);
  /**
   ...
   */
  static create(field: string): {
    eq: (value: number) => NumericFilter;
    ne: (value: number) => NumericFilter;
    gt: (value: number) => NumericFilter;
    gte: (value: number) => NumericFilter;
    lt: (value: number) => NumericFilter;
    lte: (value: number) => NumericFilter;
    between: (min: number, max: number) => NumericFilter;
  };
  toString(): string;
}
/**
 ...
 * ```
 */
declare class TextFilter extends FilterExpression {
  private field;
  private query;
  private operator;
  private negate;
  readonly filterType: "text";
  constructor(field: string, query: string, operator?: "match" | "wildcard" | "fuzzy" | "exact", negate?: boolean);
  /**
   ...
   */
  static create(field: string): {
    eq: (query: string) => TextFilter;
    ne: (query: string) => TextFilter;
    match: (query: string) => TextFilter;
    wildcard: (query: string) => TextFilter;
    fuzzy: (query: string) => TextFilter;
  };
  toString(): string;
}
/**
 ...
 * ```
 */
declare class GeoFilter extends FilterExpression {
  private field;
  private longitude;
  private latitude;
  private radius;
  private unit;
  private negate;
  readonly filterType: "geo";
  constructor(field: string, longitude: number, latitude: number, radius: number, unit?: "km" | "mi" | "m" | "ft", negate?: boolean);
  /**
   ...
   */
  static create(field: string): {
    within: (longitude: number, latitude: number, radius: number, unit?: "ft" | "km" | "m" | "mi") => GeoFilter;
    outside: (longitude: number, latitude: number, radius: number, unit?: "ft" | "km" | "m" | "mi") => GeoFilter;
  };
  toString(): string;
}
/**
 ...
 * ```
 */
declare class CustomFilter extends FilterExpression {
  private query;
 ...
 * ```
 */
declare class TimestampFilter extends FilterExpression {
  private field;
  private operator;
  private value;
  private negate;
  readonly filterType: "timestamp";
  constructor(field: string, operator: "eq" | "ne" | "gt" | "gte" | "lt" | "lte" | "between", value: Date | number | [Date | number, Date | number], negate?: boolean);
  /**
   ...
   */
  static create(field: string): {
    eq: (value: number | Date) => TimestampFilter;
    ne: (value: number | Date) => TimestampFilter;
    gt: (value: number | Date) => TimestampFilter;
    gte: (value: number | Date) => TimestampFilter;
    lt: (value: number | Date) => TimestampFilter;
    lte: (value: number | Date) => TimestampFilter;
    between: (start: number | Date, end: number | Date) => TimestampFilter;
  };
  /**
 ...
 * ```
 */
declare function Tag(field: string): {
  eq: (values: string | string[] | Set<string>) => TagFilter;
  ne: (values: string | string[] | Set<string>) => TagFilter;
};
/**
 ...
 * ```
 */
declare function Num(field: string): {
  eq: (value: number) => NumericFilter;
  ne: (value: number) => NumericFilter;
  gt: (value: number) => NumericFilter;
  gte: (value: number) => NumericFilter;
 ...
 * ```
 */
declare function Text(field: string): {
  eq: (query: string) => TextFilter;
  ne: (query: string) => TextFilter;
  match: (query: string) => TextFilter;
  wildcard: (query: string) => TextFilter;
 ...
 * ```
 */
declare function Geo(field: string): {
  within: (longitude: number, latitude: number, radius: number, unit?: "ft" | "km" | "m" | "mi") => GeoFilter;
  outside: (longitude: number, latitude: number, radius: number, unit?: "ft" | "km" | "m" | "mi") => GeoFilter;
};
/**
 ...
 * ```
 */
declare function Timestamp(field: string): {
  eq: (value: number | Date) => TimestampFilter;
  ne: (value: number | Date) => TimestampFilter;
  gt: (value: number | Date) => TimestampFilter;
  gte: (value: number | Date) => TimestampFilter;
 ...
 * ```
 */
declare function Custom(query: string): CustomFilter;
//#endregion
export { AndFilter, Custom, CustomFilter, FilterExpression, Geo, GeoFilter, Num, NumericFilter, OrFilter, Tag, TagFilter, Text, TextFilter, Timestamp, TimestampFilter };
