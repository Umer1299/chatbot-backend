...
ALTER TABLE quick_answers ADD COLUMN IF NOT EXISTS normalized_key TEXT DEFAULT '';
ALTER TABLE quick_answers ADD COLUMN IF NOT EXISTS normalized_question TEXT DEFAULT '';
...
ALTER TABLE quick_answers ALTER COLUMN normalized_question SET DEFAULT '';
